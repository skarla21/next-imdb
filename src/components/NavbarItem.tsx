  ...
  return (
    <div>
      <Link
        ...
        hover:bg-amber-50 dark:hover:bg-gray-600 transition-all duration-200  hover:scale-105 
        bg-white dark:bg-gray-700 shadow-sm hover:shadow-md border border-amber-100 dark:border-gray-600 
